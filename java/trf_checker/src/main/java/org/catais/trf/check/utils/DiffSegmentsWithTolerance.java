...
import org.catais.trf.check.utils.LineSegmentUtil;
...
public class DiffSegmentsWithTolerance {
 ...
 private SimpleFeatureCollection[] inputFC = new SimpleFeatureCollection[2];
 ...
 {
   inputFC[0] = (SimpleFeatureCollection) fc0;
   inputFC[1] = (SimpleFeatureCollection) fc1;
...
//   SimpleFeatureCollection[] diffFC = new SimpleFeatureCollection[2];
