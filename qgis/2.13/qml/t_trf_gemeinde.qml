...
<qgis version="2.13.0-Master" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="flaeche_gem">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="flaeche_ls_attr">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="flaeche_ls_calc">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="'Gemeinde: ' || &quot;flaeche_gem&quot; || '|' ||  'Liegenschaften gerechnet: ' || round(&quot;flaeche_ls_calc&quot;, 0) || '|' || 'Flaechenmass: ' || &quot;flaeche_ls_attr&quot; "/>
    ...
    <property key="labeling/multilineAlign" value="2"/>
    <property key="labeling/multilineHeight" value="1.5"/>
