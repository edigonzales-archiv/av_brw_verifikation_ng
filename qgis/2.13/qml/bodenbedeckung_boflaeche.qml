...
<qgis version="2.13.0-Master" minimumScale="-4.65661e-10" maximumScale="25000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{23fd4f91-13fd-450a-8936-eb724efdd67a}">
      <rule filter="&quot;art&quot;  =  'Gebaeude' " key="{5577a599-6ce0-4c7e-b47b-c9b1b102b365}" symbol="0" label="Gebäude"/>
      <rule filter="&quot;art&quot; IN ('Gebaeude', 'Gewaesser.fliessendes', 'befestigt.Flugplatz', 'Gewaesser.stehendes', 'befestigt.Strasse_Weg', 'befestigt.Trottoir', 'befestigt.Verkehrsinsel', 'befestigt.Wasserbecken')" key="{62bac71c-fcd2-4bc4-bf97-6d286d26eac5}" symbol="1" label="ausgezogen"/>
      <rule filter="&quot;art&quot; IN ('vegetationslos.Fels', 'vegetationslos.Gletscher_Firn', 'vegetationslos.Geroell_Sand', 'vegetationslos.Abbau_Deponie.Steinbruch', &#xa;'vegetationslos.Abbau_Deponie.Kiesgrube', 'vegetationslos.Abbau_Deponie.Deponie', 'vegetationslos.Abbau_Deponie.uebriger_Abbau', &#xa;'vegetationslos.Abbau_Deponie.uebrige_vegetationslose', 'bestockt.geschlossener_Wald', 'bestockt.Wytweide.Wytweide_dicht', &#xa;'bestockt.Wytweide.Wytweide_offen', 'bestockt.uebrige_bestockte.Parkanlage_bestockt', 'bestockt.uebrige_bestockte.Hecke', &#xa;'bestockt.uebrige_bestockte.uebrige_bestockte', 'Gewaesser.Schilfguertel', 'humusiert.Acker_Wiese_Weide.Acker_Wiese',  &#xa;'humusiert.Acker_Wiese_Weide.Weide', 'humusiert.Reben', 'humusiert.uebrige_Intensivkultur.Obstkultur', 'humusiert.uebrige_Intensivkultur.uebrige_Intensivkultur', &#xa;'humusiert.Gartenanlage.Gartenanlage', 'humusiert.Gartenanlage.Parkanlage_humusiert', 'humusiert.Gartenanlage.Sportanlage_humusiert', &#xa;'humusiert.Gartenanlage.Friedhof', 'humusiert.Hoch_Flachmoor', 'humusiert.uebrige_humusierte', 'befestigt.uebrige_befestigte.Sportanlage_befestigt', &#xa;'befestigt.uebrige_befestigte.Boeschungsbauwerk', 'befestigt.uebrige_befestigte.Lagerplatz', 'befestigt.uebrige_befestigte.Gebaeudeerschliessung', &#xa;'befestigt.uebrige_befestigte.Parkplatz', 'befestigt.uebrige_befestigte.uebrige_befestigte', 'befestigt.Bahn')&#xa;" key="{de3ee2bf-bdec-468e-af16-74517c3966a0}" symbol="2" label="gestrichelt"/>
      <rule filter="&quot;art&quot;  =  'bestockt.geschlossener_Wald' " key="{c27e6cc6-0ee7-43bb-bb97-562b30f89f10}" symbol="3" label="geschlossener Wald"/>
      <rule filter="&quot;art&quot;  IN ('bestockt.uebrige_bestockte.Parkanlage_bestockt', 'bestockt.uebrige_bestockte.Hecke', &#xa;'bestockt.uebrige_bestockte.uebrige_bestockte') " key="{c4914d6d-9e25-45a6-9b52-a6bcb905034f}" symbol="4" label="übrige bestockte"/>
    </rules>
    <symbols>
