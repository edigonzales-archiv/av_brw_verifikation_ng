...
<qgis version="2.13.0-Master" minimumScale="0" maximumScale="3000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="exaktdefiniert">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="hoheitsgrenzsteinalt">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{2dbb0168-849b-4ae8-88ec-5d464ad35d5b}">
      ...
      <rule filter="&quot;punktzeichen&quot; =  'Rohr'  AND  &quot;gueltigkeit&quot; = 'gueltig' " key="{94200da1-392a-468d-88fd-29dbba2f913a}" symbol="6" label="Rohr"/>
      ...
      <rule filter="&quot;punktzeichen&quot; =  'Pfahl'  AND  &quot;gueltigkeit&quot; = 'gueltig' " key="{431e5735-2923-48cd-95bb-5a375e2d43e6}" symbol="8" label="Pfahl"/>
