...
<qgis version="2.13.0-Master" minimumScale="0" maximumScale="3000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{7fc08882-3fca-4a7b-9150-cd13da6d0136}">
      <rule filter="&quot;punktzeichen&quot;  =  'Stein' " key="{cc0b2d53-4cf1-438b-9e23-6a90ca402aa2}" symbol="0" label="LFP3 (Stein)"/>
      <rule filter="&quot;punktzeichen&quot;  =  'Kunststoffzeichen' " key="{d5941b4b-63a2-4269-909b-49d33ef15106}" symbol="1" label="LFP3 (Kunststoffzeichen)"/>
      <rule filter="&quot;punktzeichen&quot;  =  'Bolzen' " key="{6e5cc92e-4859-46d3-b36b-91dce5d0f9a0}" symbol="2" label="LFP3 (Bolzen)"/>
      <rule filter="&quot;punktzeichen&quot;  =  'Rohr' " key="{4569fcf2-fc7c-4ad4-bd9f-77d8590db70e}" symbol="3" label="LFP3 (Rohr)"/>
      <rule filter="&quot;punktzeichen&quot;  =  'Pfahl' " key="{edb85c1b-935f-4f05-a630-1a85a91ee225}" symbol="4" label="LFP3 (Pfahl)"/>
      <rule filter="&quot;punktzeichen&quot;  =  'Kreuz' " key="{2ff5c295-af16-4b5e-a63c-3d7ea0651861}" symbol="5" label="LFP3 (Kreuz)"/>
      <rule filter="&quot;punktzeichen&quot;  =  'weitere' " key="{fbc3681d-63c5-4179-89bd-1080d68d43a6}" symbol="6" label="LFP3 (weitere)"/>
    </rules>
    <symbols>
