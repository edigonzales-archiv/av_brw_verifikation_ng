...
<qgis version="2.13.0-Master" minimumScale="0" maximumScale="3000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="objektnamepos_von">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Size" value="1~~1~~CASE &#xa;WHEN $scale &lt; 750 THEN 11&#xa;WHEN $scale >= 750 AND $scale &lt; 1250 THEN 7.7&#xa;WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 6.0&#xa;END~~"/>
    <property key="labeling/dataDefined/Vali" value="1~~0~~CASE &#xa;WHEN &quot;hali&quot; = 0 THEN 'Left'&#xa;WHEN &quot;hali&quot; = 1 THEN 'Center'&#xa;WHEN &quot;hali&quot; = 2 THEN 'Right'&#xa;END~~vali"/>
