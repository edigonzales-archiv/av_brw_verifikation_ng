...
<qgis version="2.13.0-Master" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="t_index">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{637a719e-75c0-46d8-bb22-cb82cc4ebac6}">
      <rule filter="&quot;t_index&quot; = 0" key="{20ad7f10-1816-4094-a585-a3cc88e6cbde}" symbol="0" label="NF (nicht in IG)"/>
      <rule filter="&quot;t_index&quot; = 1" key="{36b754dd-a920-45b0-bb86-f58fceac4bae}" symbol="1" label="IG (nicht in NF)"/>
    </rules>
    <symbols>
