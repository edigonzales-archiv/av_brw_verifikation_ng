...
<qgis version="2.13.0-Master" minimumScale="0" maximumScale="3000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="punktelement_von">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{beae2b71-40c1-42c3-bc09-176dc1661fef}">
      <rule filter="&quot;art&quot; =  'Bildstock_Kruzifix' " key="{92a35cc6-a6a9-4596-a4dd-0146fe287bac}" symbol="0" label="Bildstock, Kruzifix"/>
      <rule filter="&quot;art&quot; = 'Denkmal'" key="{b535fb7d-338e-475e-870f-6a79fce0a33e}" symbol="1" label="Denkmal"/>
      <rule filter="&quot;art&quot; = 'einzelner_Fels'" key="{f970b3f8-b3d0-46a6-8e48-05e76df63e72}" symbol="2" label="einzelner Fels"/>
      <rule filter="&quot;art&quot; = 'Grotte_Hoehleneingang'" key="{be4d3237-8f09-4ebb-962d-46fab8a2c137}" symbol="3" label="Grotte, Höhleneingang"/>
      <rule filter="&quot;art&quot; = 'Mast_Antenne'" key="{f11f0177-8bfa-4728-8aed-c299fb0e68fa}" symbol="4" label="Mast, Antenne"/>
      <rule filter="&quot;art&quot; = 'Quelle'" key="{78553d3d-4f82-4e16-8a96-7c0fc353c253}" symbol="5" label="Quelle"/>
      <rule filter="&quot;art&quot; = 'wichtiger_Einzelbaum'" key="{6d17f62d-8f96-421d-98ba-eb24d85e0a80}" symbol="6" label="wichtiger Einzelbaum"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="name" v="grundbuchplan/symbol_j_bildstock_kruzifix.svg"/>
          <prop k="offset" v="0,0"/>
          ...
          <prop k="size_dd_expression" v="CASE WHEN $scale &lt; 750 THEN 125 WHEN $scale >= 750 AND $scale &lt; 1250 THEN 64 WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 32 WHEN $scale >= 3000 THEN 16 END"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="3">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="color" v="0,0,0,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="grundbuchplan/symbol_f_grotte_hoehleneingang.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="0,0,0,255"/>
