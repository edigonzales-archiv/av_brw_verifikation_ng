    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="width_dd_expression" v="CASE WHEN $scale &lt; 750 THEN 0.6 WHEN $scale >= 750 AND $scale &lt; 1250 THEN 0.5 WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 0.3 WHEN $scale >= 3000 AND $scale &lt; 6000 THEN 0.22 ELSE 0.5 END"/>
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="customdash_dd_expression" v="CASE WHEN $scale &lt; 750 THEN '4.9;1.4;1.4;1.4' WHEN $scale >= 750 AND $scale &lt; 1250 THEN '3.5;1.0;1.0;1.0' WHEN $scale >= 1250 AND $scale &lt; 3000 THEN '2.45;0.7;0.7;0.7' WHEN $scale >= 3000 AND $scale &lt; 6000 THEN '1.75;0.5;0.5;0.5' WHEN $scale >= 3000 AND $scale &lt; 20000 THEN '2.45;0.7;0.7;0.7' ELSE '1;0' END"/>
          ...
          <prop k="use_custom_dash" v="0"/>
          <prop k="width_dd_active" v="1"/>
          <prop k="width_dd_expression" v="CASE WHEN $scale &lt; 750 THEN 0.56 WHEN $scale >= 750 AND $scale &lt; 1250 THEN 0.4 WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 0.28 WHEN $scale >= 3000 AND $scale &lt; 6000 THEN 0.2 ELSE 0.4 END"/>
          <prop k="width_dd_field" v=""/>
          <prop k="width_dd_useexpr" v="1"/>
          <prop k="width_map_unit_scale" v="0,0,0,0,0,0"/>
        </layer>
